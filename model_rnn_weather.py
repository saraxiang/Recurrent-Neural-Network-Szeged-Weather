...
class LstmRNN(object):
    def __init__(self, sess,
                 ...
                 input_size=1,
                 embed_size=None,
                 logs_dir="logs_weather",
                 plots_dir="images_weather"):
        """
        ...
        Args:
            ...
            embed_size (int): length of embedding vector
            checkpoint_dir (str)
        """
        self.sess = sess
    ...
    def build_graph(self):
        ...
        if self.embed_size > 0:
            self.embed_matrix = tf.Variable(
                tf.random_uniform([1, self.embed_size], -1.0, 1.0),
                name="embed_matrix"
            )
    ...
    def train(self, dataset_list, config):
        ...
        self.writer = tf.summary.FileWriter(os.path.join("./logs_weather", self.model_name))
        ...
        # Merged test data of different places.
        merged_test_X = []
        merged_test_y = []
        merged_test_labels = []
